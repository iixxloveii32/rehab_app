class ExerciseDef {
  ...
  /// record/review 화면에서 보여줄 짧은 안내 문구
...
class Exercises {
  static const list = <ExerciseDef>[
    ExerciseDef(
      ...
      taskGuide: '처음 맞춘 위치에서 팔을 앞으로 천천히 들어 주세요.',
    ...
    ExerciseDef(
      ...
      taskGuide: '처음 맞춘 위치에서 팔을 옆으로 천천히 들어 주세요.',
    ...
    ExerciseDef(
      ...
      taskGuide: '처음 맞춘 위치에서 손을 머리 쪽으로 천천히 가져가 주세요.',
    ...
    ExerciseDef(
      ...
      taskGuide: '처음 맞춘 위치에서 손을 허리 뒤쪽으로 천천히 가져가 주세요.',
    ...
    ExerciseDef(
      ...
      taskGuide: '처음 맞춘 위치에서 목표 지점을 향해 손을 앞으로 뻗어 주세요.',
    ...
    ExerciseDef(
      ...
      taskGuide: '처음 맞춘 위치에서 목표 지점을 향해 손을 옆으로 뻗어 주세요.',
    ...
    ExerciseDef(
      ...
      taskGuide: '처음 맞춘 위치에서 손을 입 쪽으로 천천히 가져가 주세요.',
    ...
    ExerciseDef(
      ...
      taskGuide: '처음 맞춘 위치에서 팔꿈치를 펴며 손을 앞으로 뻗어 주세요.',
